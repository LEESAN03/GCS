...
// is a float is zero
            ...
            double rollRate, double pitchRate, double yawRate)
        {
            ...
            //        Z    Y     X
            // roll  -Sp, CpSr, Cnumr
            // pitch SzCp, SzSpSr+CzCr, SzSnumr-Cnumr
            // yaw   CzCp, CzSpSr-SzCr, CzSnumr+SzSr
            ...
            double z)
        {
            ...
            // Cnumy, CpSy, -Sp					| local_ax
            // SrSnumy-CrSy, SrSpSy+CrCy, SrCp	| local_ay
            // CrSnumy+SrSy, CrSpSy-SrCy, CrCp	| local_az
